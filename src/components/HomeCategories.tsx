...
const HomeCategories = ({ categories }: { categories: Category[] }) => {
  return (
    <div className="bg-white border border-shop-pastel-blue/20 my-10 md:my-20 p-5 lg:p-7 rounded-md">
        ...
        {categories?.map((category) => (
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                <span className="font-bold text-shop-dark-blue">{`(${category?.productCount})`}</span>{" "}
                Items Available 
              </p>
            </div>
          </div>
